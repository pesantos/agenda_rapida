...
public class CadUsuario extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(!campoNome.getText().equals("")){
            if(udao.nomeValido(campoNome.getText())){
                Usuario novo = new Usuario();
                novo.setNome(campoNome.getText().trim());
                novo.setSenha("123");
                udao.inserirUsuario(novo);
                Pref.save("USUARIO", novo.getNome());
                JOptionPane.showMessageDialog(this, "Usuario registrado com sucesso!");
                limpar();
                
            }else{
                Pref.save("USUARIO", campoNome.getText().trim());
                JOptionPane.showMessageDialog(this, "Nome invalido ou ja utilizado!");
                Pref.save("USUARIO", campoNome.getText().trim());
                limpar();
            }
        }else{
            JOptionPane.showMessageDialog(this, "Necessario entrar com um nome!");
        }
